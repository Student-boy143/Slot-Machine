  ...
  while True:
    ...
    if lines.isdigit():
      ...
      if 1 <= lines <= MAX_LINES:
        ...
        print("Enter valid number of lines from 1 to 3")
    else:
      print("Please enter a number.")
  ...
  while True:
    ...
    if amount.isdigit():
      ...
      if MIN_BET <= amount <= MAX_BET:
        ...
        print(f"Amount should be in the range of ${MIN_BET} to ${MAX_BET}.")
    else:
      print("Please enter a number.")
...
def spin(balance):
  ...
  while True:
    ...
    if total_bet > balance:
      print(f"You dont have enough balance to bet on, your current balance is: ${balance}")
    else:
      break
  ...
  print(f"You won on following lines: ", *winning_lines)
